...
exports.DatePicker = function (_a) {
    ...
    return (React.createElement(formik_1.Field, { name: name, validate: validate }, function (_a) {
        ...
        return (React.createElement(antd_1.DatePicker, tslib_1.__assign({ value: value ? moment_1["default"](value) : undefined, onChange: function (date) { return setFieldValue(name, date ? date.toISOString() : null); } }, restProps)));
    }));
};
